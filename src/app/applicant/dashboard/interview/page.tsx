...
export default async function InterviewsPage() {
            ...
            <CardContent className="py-16">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground max-w-md">
                  You do not have any interviews scheduled at the moment. Check
                  back later or contact your recruiter.
                </p>
              </div>
            </CardContent>
          </Card>
  ...
  const attemptedInterviews = interviewSessions.filter(
    (session) => session.attempted
  );
                ...
                <Card className="overflow-hidden border shadow-sm">
                  <CardContent className="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-muted-foreground max-w-sm">
                      You do not have any upcoming interviews scheduled at the
                      moment.
                    </p>
                  </CardContent>
                </Card>
              ...
              {expiredInterviews.length > 0 ? (
                ...
                <Card className="overflow-hidden border shadow-sm">
                  <CardContent className="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-muted-foreground max-w-sm">
                      You do not have any past interviews in your history.
                    </p>
                  </CardContent>
                </Card>
              )}
      ...
      <CardHeader className="bg-muted/20 border-b">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge
              variant={interview.type === "CODE" ? "secondary" : "default"}
              className="shadow-sm"
            >
              {interview.type === "CODE" ? (
                <>
