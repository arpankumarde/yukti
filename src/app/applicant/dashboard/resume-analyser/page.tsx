    ...
    <div className="container mx-auto py-10 px-4 md:px-6">
      <Card className="border shadow-sm">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <CardDescription>
                Upload your resume to get ATS compatibility analysis
              </CardDescription>
            </div>
          </div>
        </CardHeader>
                ...
                {isUploading ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-muted-foreground mb-6 text-center">
                      Upload your resume in PDF format to analyze its
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      <TabsContent value="normal" className="mt-0 space-y-4">
                        <div className="flex items-center gap-2 px-4 py-3 bg-primary/10 rounded-md">
                          ...
                          <p className="text-sm">
                            Standard ATS compatibility check will analyze how
                            well your resume performs with typical ATS systems.
                          </p>
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="jobMatch" className="mt-0 space-y-4">
                        <div className="flex items-center gap-2 px-4 py-3 bg-primary/10 rounded-md">
                          <AlertCircle className="h-5 w-5 text-primary" />
                          <p className="text-sm">
                            Job match will analyze how well your resume matches
                    ...
                    <Button
                      ...
                      disabled={
                        isAnalyzing ||
                        (analysisType === "jobMatch" && !jobProfile.trim())
                      }
                    >
                      {isAnalyzing ? (
                        <>
        ...
        <CardFooter className="flex items-center justify-between border-t px-6 py-4 bg-muted/20">
          <p className="text-xs text-muted-foreground">Powered by Yukti AI</p>
